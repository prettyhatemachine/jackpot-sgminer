...
#define TFBIG_KINIT(k0, k1, k2, k3, k4, k5, k6, k7, k8, t0, t1, t2)                    \
		k8 = ((k0 ^ k1) ^ (k2 ^ k3)) ^ ((k4 ^ k5) ^ (k6 ^ k7)) ^ 0x1BD11BDAA9FC1A22UL; \
		t2 = t0 ^ t1;
...
__constant ulong SKEIN_INI[] = {
	 0x4903ADFF749C51CEUL, 0x0D95DE399746DF03UL,
	 0x8FD1934127C79BCEUL, 0x9A255629FF352CB1UL,
	 0x5DB62599DF6CA7B0UL, 0xEABE394CA9D5C3F4UL,
	 0x991112C71A75B523UL, 0xAE18A40B660FCC33UL
};
